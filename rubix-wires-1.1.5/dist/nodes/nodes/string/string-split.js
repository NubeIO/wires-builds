...
class TextSplitStringsNode extends node_1.Node {
    constructor() {
        ...
        this.addInputWithSettings('separator', node_1.Type.STRING, '', 'Separator Value', false);
        this.addInput('start', node_1.Type.BOOLEAN);
        this.addInput('next', node_1.Type.BOOLEAN);
        this.addOutput('output', node_1.Type.STRING);
        this.addOutput('left', node_1.Type.NUMBER);

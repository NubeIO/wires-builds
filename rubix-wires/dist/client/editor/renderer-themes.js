...
class RendererTheme {
    constructor() {
        ...
        this.UNKNOWN_NODE_COLOR = '#777';
        this.UNKNOWN_NODE_BGCOLOR = '#A44';
        ...
        this.TITLE_TEXT_FONT = 'normal 11px Arial';
        this.NAME_TEXT_FONT = 'normal 8px Arial';
        this.INNER_TEXT_FONT = 'normal 12px Arial';
        this.INNER_LARGE_TEXT_FONT = 'normal 14px Arial';
        ...
        this.STATE_COLORS = {
            [node_1.NodeState.NORMAL]: '#C9CAC4',
...
theme0.DATATYPE_COLOR = { 0: '#AAAAAA', 1: '#7D6B91', 2: '#87BBA2' };
theme0.LINK_TYPE_COLORS = { 0: '#AAAAAA', 1: '#7D6B91', 2: '#87BBA2' };

...
class StringSelectNode extends flexible_node_1.FlexibleNode {
    constructor() {
        super();
...
container_1.Container.registerNodeType('switch/string-select', StringSelectNode);
//# sourceMappingURL=string-select.js.map
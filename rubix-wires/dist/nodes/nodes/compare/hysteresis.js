...
class HysteresisNode extends node_1.Node {
    constructor() {
        ...
        this.addInputWithSettings('risingEdge', node_1.Type.NUMBER, 20, 'Rising Edge', false);
        this.addInputWithSettings('fallingEdge', node_1.Type.NUMBER, 10, 'Falling Edge', false);

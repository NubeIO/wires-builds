...
class TriggerAddNode extends flexible_node_1.FlexibleNode {
    constructor() {
        super();
...
container_1.Container.registerNodeType('math-trigger/trigger-add', TriggerAddNode);
//# sourceMappingURL=trigger-add.js.map
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (type === 1) {
                    ...
                    if (pntDataType !== 0) {
                        let val = yield ModbusMethods.dataTypeCase(pntDataType);
                        methodType = [regAddr, val];
                    }
                    else
                        methodType = [regAddr, regLength];
                }
...
ModbusMethods.modbusMethods = (thisInstance, id, type, regAddr, regLength, nodeInputValue, pntDataType, pntDataEndian) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let dBug = true;
    if (dBug) {
        console.log(`Modbus call @  ${id}, FC: ${ft.funcType}, regAddr: ${regAddr}, length: ${regLength} , writeVal: ${nodeInputValue} , pntDataType: ${pntDataType}, pntDataEndian: ${pntDataEndian}`);
    }

...
class BACnetPoint extends container_node_1.ContainerNode {
    ...
    onInputUpdated() {
        if (this.side !== container_1.Side.server)
            return;
        history_utils_1.default.doHistoryFunctions(this).then();
        let objectType;
        let objectInstance;
    ...
    onAfterSettingsChange() {
        history_utils_1.default.historyFunctionsForAfterSettingsChange(this, this.settings['pointName'].value).then();
        this.getPresentValue();

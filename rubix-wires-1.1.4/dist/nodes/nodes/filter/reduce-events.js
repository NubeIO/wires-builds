...
class FiltersReduceEventsNode extends node_1.Node {
    constructor() {
        ...
        this.description =
            'This node reduces the number of transmitted values. <br/><br/>' +
...
container_1.Container.registerNodeType('filter/reduce-events', FiltersReduceEventsNode);
//# sourceMappingURL=reduce-events.js.map
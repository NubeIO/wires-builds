...
class GetSchedulesNode extends node_1.Node {
    ...
    getDeviceID() {
        return new Promise((resolve, reject) => {
            try {
                history_utils_1.default.findMainContainer(this).db.getNodeType('system/platform', (err, docs) => {
                    if (!err) {
                        let output = [];
                        output.push(docs);
    ...
    findMainContainer() {
        if (this.hasOwnProperty('container'))
            return history_utils_1.default.findMainContainer(this.container);
        else
            return this;
    }
    setExecuteInterval() {
